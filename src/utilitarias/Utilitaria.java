...
public class Utilitaria {
    ...
    public String enviarMensaje(String provincia, String numero){
        try {
        // Construct data
        String user = "username=" + "proyectopoo2016@hotmail.com";
        String hash = "&hash=" + "b602a53eb92e8e47346ce34a32f113794976231d";
        String message = "&message=" + "Se le notifica de un sismo en la provincia de "+provincia;
        String sender = "&sender=" + "Sismos Poo";
